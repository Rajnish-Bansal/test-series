...
import { AlertCircle, Target, Brain, ArrowRight } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-6 w-full">
            <div className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-2">Revise the questions you answered incorrectly.</p>
                </div>
                <div className="bg-red-50 text-red-600 px-4 py-2 rounded-xl border border-red-100 font-bold flex flex-col items-center">
                ...
                <div className="flex flex-col gap-4">
                    {errors.map((errItem) => (
                        <div key={errItem._id} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                            <div className="bg-slate-50 border-b border-slate-100 px-6 py-3 flex justify-between items-center text-sm font-medium">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-slate-600 uppercase tracking-wider text-xs">
                                        {errItem.topic} • {errItem.microTag}
                                    </span>
                                </div>
                            ...
                            <div className="p-6">
                                <h3 className="text-slate-800 font-semibold mb-6 whitespace-pre-wrap leading-relaxed">
                                    {errItem.questionText}
                                </h3>
